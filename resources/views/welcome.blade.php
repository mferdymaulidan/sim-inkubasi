    ...
    <body class="wow text-[#1b1b18] w-full items-center lg:justify-center min-h-screen flex-col bg-[#48B3AF]">
        <header class="bg-[#476EAE] w-full lg:max-w-full max-w-full text-sm not-has-[nav]:hidden p-6 sticky top-0 z-50">
            <div class="container relative flex grow">
                ...
                <div class="justify-end items-center lg:flex grow">
                    @if (Route::has('login'))
                        <nav class="flex items-center justify-end gap-4">
                            @auth
                                <a
                                    href="{{ url('/dashboard') }}"
                                    class="inline-block px-4 py-3 bg-blue-500 text-white rounded-md text-sm leading-normal"
                                >
                                    Dashboard
                                </a>
                            @else
                                ...
                                <!-- @if (Route::has('register'))
                                    <a
                                        href="{{ route('register') }}"
                                        class="inline-block px-4 py-3 bg-gray-500 text-white rounded-md text-sm leading-normal">
                                        Daftar
                                    </a>
                                @endif -->
                            @endauth
        ...
        <div>
        <div class="container px-4 mx-auto bg-[#48B3AF]">
          <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4">
              <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s;">
                <h1 class="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2] pt-4">
                  Cyber Class <br> SMK IT Asy-Syadzili
                </h1>
                <p class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  Kelas Pengembangan bakat siswa dalam bidang teknologi, meliputi Programming, Jaringan, dan IoT.
                </p>
                <ul class="flex flex-wrap items-center justify-center gap-5 mb-10">
                  <li>
                    <a href="https://smkitasy-syadzili.sch.id/" target="_blank" class="inline-flex items-center justify-center rounded-md bg-white px-7 py-[14px] text-center text-base font-medium text-dark shadow-1 transition duration-300 ease-in-out hover:bg-gray-2 hover:text-body-color">
                      Website Sekolah
                    </a>
                  </li>
                </ul>
            ...
            <div class="w-full px-4">
              <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s" style="visibility: visible; animation-delay: 0.25s;">
                <div class="mt-16">
                  <img src="storage/img.webp" alt="hero" class="max-w-full mx-auto rounded-t-xl rounded-tr-xl">
                </div>
              </div>
            </div>
          </div>
...
<section
      id="team"
      class="w-full overflow-hidden bg-gray-100 pb-12 pt-20 dark:bg-dark-2 lg:pb-[90px] lg:pt-[120px]"
    >
      <div class="px-4 mx-auto">
        ...
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            <div
              class="px-5 pt-12 pb-10 mb-8 bg-[#A7E399] hover:bg-[#48B3AF] group rounded-xl shadow-testimonial dark:bg-dark dark:shadow-none"
            >
              <div class="relative z-10 mx-auto mb-7 h-[120px] w-[120px]">
                <img
                  src="storage/pakren.webp"
                  alt="team image"
                  class="h-[140px] w-[140px] object-cover rounded-full"
                />
                <span
              ...
              <div class="text-center">
                <h4
                  class="mb-1 text-lg font-semibold text-black"
                >
                  Rendy Yani Susanto, S.Pd
                </h4>
                <p class="mb-5 text-sm text-black">
                  Penasehat Cyber Class
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            <div
              class="px-5 pt-12 pb-10 mb-8 bg-[#A7E399] hover:bg-[#48B3AF] group rounded-xl shadow-testimonial"
            >
              <div class="relative z-10 mx-auto mb-7 h-[120px] w-[120px]">
                <img
                  src="storage/fer.webp"
                  alt="team image"
                  class="h-[140px] w-[140px] object-cover rounded-full"
                />
                <span
        ...
        <footer
      class="wow fadeInUp relative z-10 bg-[#476EAE] pt-10 lg:pt-[50px] w-full pt-20"
      data-wow-delay=".15s"
    >
      <div class="container px-4 mx-auto">
        <div class="flex items-center flex-wrap -mx-4">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="w-full mb-10 pl-3">
              <a
              ...
              <p class="mb-8 max-w-[270px] text-base text-white">
                Cyber Class - SMK IT Asy Syadzili (Pakis - Malang)
              </p>
              <div class="flex items-center -mx-3">
                <a
                  href="https://www.instagram.com/thecyberclass"
                ...
                <a href="https://www.instagram.com/thecyberclass" class="text-white">@thecyberclass</a>
              </div>
            </div>
          </div>
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div class="w-full mb-10  pl-3">
              <h4 class="text-lg font-semibold text-white mb-9">Tentang Kami</h4>
              <ul>
                <li>
                  <a
                    href="/"
                    class="inline-block mb-3 text-base text-white hover:text-primary"
                  >
                    Beranda
                  </a>
                </li>
            ...
            <div class="flex flex-wrap -mx-2 sm:-mx-4 lg:-mx-2 xl:-mx-4">
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  <div class="mb-4 sm:mb-8 sm:h-[400px] md:h-[540px] lg:h-[400px] xl:h-[500px]">
                    <img src="storage/img2.webp" alt="about image" class="object-cover object-center w-full h-full"/>
                  </div>
                </div>

                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  <div class="mb-4 sm:mb-8 sm:h-[220px] md:h-[346px] lg:mb-4 lg:h-[225px] xl:mb-8 xl:h-[310px]">
                    <img src="storage/img3.webp" alt="about image" class="object-cover object-center w-full h-full"/>
                  </div>
                  <div class="relative z-10 mb-4 flex items-center justify-center overflow-hidden bg-[#48B3AF] px-6 py-12 sm:mb-8 sm:h-[160px] sm:p-5 lg:mb-4 xl:mb-8">
                    <div>
      ...
      <div class="mt-3 border-t border-[#8890A4]/40 py-2 lg:mt-[20px]">
        <div class="container px-4 mx-auto">
          <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4">
              <div class="justify-center my-1">
                <p class="text-base text-white text-center">
                  Made With Love ♥ by
                    <a
                      href="https://smkitasy-syadzili.sch.id/author/maspre/"
